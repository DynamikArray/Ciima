      ...
      <div class="grey darken-4 px-3 py-2">
        <div class="d-flex justify-space-between align-center">
          <div class="d-flex align-center">
            <h4 class="mb-1 text-left">Include up to 12 product images</h4>
          </div>
          <div class="d-flex align-center">
            <input
              ref="input"
...
export default {
  ...
  computed: {
    ...
    images: {
      get() {
        return this.$store.state.gtcs.draft.images;
      },
      set(value) {
        this.$store.commit(`gtcs/draft/${UPDATE_GTC_DRAFT_IMAGES}`, value);
      }
    }
  },
  methods: {
    clearImgSrc() {
      this.$store.commit(`gtcs/draft/${GTC_SET_IMAGE_TO_CROP}`, false);
      this.cropImg = false;
    },
    cropImage() {
