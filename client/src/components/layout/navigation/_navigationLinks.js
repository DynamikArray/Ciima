module.exports = [
  ...
  */
  ...
  { menuDivider: true },
  { icon: "fa fa-search", text: "Search Inventory", to: "inventory" },
  { icon: "fas fa-boxes", text: "Locations", to: "locations", roles: ["isManager"] },
  { menuDivider: true },
  { icon: "fas fa-cash-register ", text: "Whatnot", to: "whatnot" },
  { menuDivider: true },
